...
<option value="musicandentertainment">Music & Entertainment</option>
<option value="moviesandtv">Movies & TV</option>
<option value="anime">Anime</option>
<option value="popandculture">Pop & Culture</option>
...
<option value="hobbiesandcollectibles">Hobbies & Collectibles</option>
<option value="placesandtravel">Places & Travel</option>
<option value="homeandgarden">Home & Garden</option>
<option value="educationandcareer">Education & Career</option>
<option value="humanitiesandlaw">Humanities & Law</option>
<option value="books">Books</option>
<option value="natureandoutdoors">Nature & Outdoors</option>
<option value="environmentandclimate">Environment & Climate</option>
<option value="vehiclesandmachinery">Vehicles & Machinery</option>
